...
from gym_Node.envs.Exception import (
    ConnectionToDroneException
)

from gym_Node.envs.State import NodeState, TentacleState, EtcState
...
class NodeEnv(gym.Env):
    ...
    def reset(self, run_mode=REAL_MODE, configuration_file=None, log_file='logtest'):
        self.__nt_int = 'wlan0'
    ...
    def __update_reward(self):
        ...
        #print(avg_signal, self.__highSQ, self.__lowSQ)
